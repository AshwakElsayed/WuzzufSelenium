...
public class careerInterestsPage extends base{
    ...
    final public By title =By.xpath("//*[@title=\"Career Interests\"]//h1[2]");
    final protected By level = By.xpath("//*[@name=\"careerLevel\"]//div[2]");
    final protected By typeOfJob = By.xpath("//button[@title=\"Full Time\"]/span");
    final protected By workplace = By.xpath("//button[@title=\"On-site\"]/span");
